...
In einem Rechnungseingang sind die Mandanten und die Anzahl ihrer zur Bestätigung ausstehenden Rechnungen aufgelistet. Beim Auswählen eines Mandante wird auf eine Liste seiner eingegangenen Rechnungen weitergeleitet, welche dann als einzelne Rechnungen korrigiert und in das System aufgenommen werden können.

\includegraphics[scale=0.1]{SingleReceiptReview}

Innerhalb eines Jahres können die Rechnungen nach Datum und Betrag sortiert werden, um dem Steuerberater das Suchen der Rechnungen/Belege möglichst einfach und schnell zu gestalten.\\ \\
